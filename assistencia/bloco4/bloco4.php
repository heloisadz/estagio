...
include 'C:\xampp\htdocs\assistencia\bairro\crudbairro.php'; // Inclua o arquivo CRUD para bairro
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $_SESSION["F_1_1"] = $_POST["F_1_1"];
    $_SESSION["F_1_2"] = $_POST["F_1_2"];
    $_SESSION["F_2_1"] = $_POST["F_2_1"];
    $_SESSION["F_2_2"] = $_POST["F_2_2"];
    
    header("Location: ../bloco4/crud4.php");
    exit();
}
?>
